...
class WebsitesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create website" do
    assert_difference('Website.count') do
      post websites_url, params: { website: { top_level_domain: @website.top_level_domain } }
    end
  ...
  test "should update website" do
    patch website_url(@website), params: { website: { top_level_domain: @website.top_level_domain } }
