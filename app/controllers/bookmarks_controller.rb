class BookmarksController < ApplicationController
  ...
  # GET /bookmarks.json
  def index
    @bookmarks = Bookmark.order("id desc").paginate(:per_page => 5, :page => params[:page])
  end
  ...
  private
    ...
    def set_bookmark
      # default code generated by scaffolding
    ...
    def bookmark_params
      params.require(:bookmark).permit(:title, :url, :short_url, :all_tags).merge(user: current_user)
    end
end
